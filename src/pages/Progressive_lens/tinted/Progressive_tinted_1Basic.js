...
const basicLenses = [
  {
    ...
    prices: [
      ...
      { refraction: "1.67", regular: getRoundedRetail(164000), sale: 164000 }
    ],
    recommend: ["가격중시형 누진다초점"],
    features: ["최저가 누진다초점", "근용안경 대용으로 추천"],
    options: ["기본코팅, 블루라이트 불가"]
  },
  {
    productName: "C1",
    ...
    prices: [
      ...
      { refraction: "1.67", regular: getRoundedRetail(174000), sale: 174000 },
      { refraction: "1.74", regular: getRoundedRetail(234000), sale: 234000 }
    ],
  ...
  },
  {
    ...
    prices: [
      { refraction: "1.50", regular: getRoundedRetail(174000), sale: 164000 },
