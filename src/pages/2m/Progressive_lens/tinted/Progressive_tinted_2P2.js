...
const sampleLenses = [
  {
    ...
    prices: [
      { refraction: "1.50", regular: 300000 },
      { refraction: "1.60", regular: 340000 },
	  { refraction: "1.67", regular: 410000 },
	  { refraction: "1.74", regular: 530000 }
    ],
    discountRate: 0.5,
    options: ["프리미엄 코팅 3만원 추가(1.74 불가)"]
  },
  {
    brandLogo: "/logos/pentax.png",
    ...
    prices: [
	  ...
	  { refraction: "1.74", regular: 720000 }
    ],
    discountRate: 0.5,
    options: ["프리미엄 코팅 3만원 추가(1.74 불가)"]
  },
  {
    ...
    prices: [
      { refraction: "1.50", regular: 560000 },
      { refraction: "1.60", regular: 600000 },
	  { refraction: "1.67", regular: 680000 },
	  { refraction: "1.74", regular: 850000 }
    ],
    discountRate: 0.5,
    options: ["프리미엄 코팅 3만원 추가(1.74 불가)"]
  },
  {
    ...
    prices: [
	  ...
	  { refraction: "1.74", regular: 970000 }
    ],
    discountRate: 0.5,
    options: ["프리미엄 코팅 3만원 추가(1.74 불가)"]
  }
...
export default function Progressive_tinted_2P() {
