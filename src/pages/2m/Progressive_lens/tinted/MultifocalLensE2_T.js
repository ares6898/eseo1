...
const sampleLenses = [
  ...
  },
  {
    ...
    prices: [
      { refraction: "1.50", regular: 420000 },
  ...
  },
  {
    ...
    prices: [
      { refraction: "1.50", regular: 510000, sale: 219000 },
      { refraction: "1.60", regular: 600000, sale: 279000 },
      { refraction: "1.67", regular: 740000, sale: 319000 }
    ],
    discountRate: 0.5,
    options: ["블루라이트 코팅 불가"]
  },
  {
    ...
    prices: [
      ...
      { refraction: "1.67", regular: 890000 }
    ],
    discountRate: 0.45,
    options: ["블루라이트 코팅 불가"]
  }
      ...
      <div className="max-w-7xl mx-auto px-3 py-10 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-7">
        {[...sampleLenses].reverse().map((lens, idx) => {
          ...
          return (
            <div
              key={idx}
              className={`relative bg-white rounded-2xl p-5 flex flex-col gap-4 border shadow hover:shadow-2xl transition ${isE3 ? 'ring-4 ring-pink-300/80' : ''}`}
